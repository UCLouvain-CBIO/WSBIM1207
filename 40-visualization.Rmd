...
```{r color-by-species1, cache=FALSE}
ggplot(data = surveys_complete, mapping = aes(x = weight, y = hindfoot_length)) +
...
```{r color-by-species2, cache=FALSE}
...
```{r color-by-species3, cache=FALSE}
ggplot(data = surveys_complete, mapping = aes(x = weight, y = hindfoot_length, color = species_id)) +
...
```{r facet-by-species-and-sex, cache=FALSE}
...
```{r facet-by-species-and-sex-white-bg, cache=FALSE}
 ggplot(data = yearly_sex_counts, mapping = aes(x = year, y = n, color = sex)) +
     geom_line() +
     facet_wrap(~ species_id) +
     theme_bw() +
...
```{r number-species-year-with-right-labels, cache=FALSE}
ggplot(data = yearly_sex_counts, mapping = aes(x = year, y = n, color = sex)) +
    geom_line() +
    facet_wrap(~ species_id) +
...
```{r number-species-year-with-right-labels-xfont-size, cache=FALSE}
ggplot(data = yearly_sex_counts, mapping = aes(x = year, y = n, color = sex)) +
    geom_line() +
    facet_wrap(~ species_id) +
    labs(title = "Observed species in time",
...
```{r number-species-year-with-theme, cache=FALSE}
ggplot(data = yearly_sex_counts, mapping = aes(x = year, y = n, color = sex)) +
    geom_line() +
    facet_wrap(~ species_id) +
    labs(title = "Observed species in time",
...
```{r number-species-year-with-right-labels-xfont-orientation, cache=FALSE}
