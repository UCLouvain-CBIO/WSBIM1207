...
changes comparing time 8 versus time 0 and time 4 versus time 0. To
...
biotype that we will use later on to represent the genes.
...
the violins according to the time with `fill`.
...
mice. To do that we need to make the mean expression in the data frame
...
'time' and 'mean_exp', add a title to the figure and change the colour
legend title:
...
unique genes per chromosome. We also change the scale of the yaxis to
