...
Today, it is difficule to overestimate the very broad importance and
...
critical about data. Rather that teaching a limited set of software
tools, this course aims at teaching a set of skills and methodologies
that allow to interrogate and visualise data, and hence be in a
position to be critical with respect to ones data. In addition, while
specific software become obsolete and are replaced, or are specific to
one specific field of research, critical investigation of data will
always be required and will never be replaced.
