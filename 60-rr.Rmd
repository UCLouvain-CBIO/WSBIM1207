...
5. As discussed during the course, we need data in a long format to be
   ...
   format using `pivot_longer()` (or `gather()`). Display the first
   rows of these new data and write a short sentence describing them
   and the transformation you just applied.
