...
- Describe best practices for organising data so computers can make
...
quality control functions. See also @Broman:2018 and @Hertz:2024.
...
first preliminary experiment. Data organisation is the foundation of
...
Once you have tidied up the data, compare the tidy and messy versions
of the data, and reflect/discuss with your neighbour to how
easy/difficult it would be to answer the following questions.
...
\@ref(fig:analysis), where data is repeatedly transformed, visualised,
...
cleaning up and preparing the data, rather than actually analysing
