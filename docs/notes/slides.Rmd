...
Assistant(e)s: Mathilde Akue, Léopold Guyot, Dr Axelle Loriot (M1),
Youssef Salem (moniteur).
...
- Appliquer les compétences ci-dessus à l'analyse de données de
  RNA-Seq et de protéomique quantitative en utilisant des packages
  R/Bioconductor dédiés.
...
Interrogations hebdomadaires non cotées. Correction en classe.
...
- Interrogations et examen à **ressources ouvertes** (notes de cours,
  scripts et cheat sheets).
...
knitr::include_graphics("https://github.com/UCLouvain-CBIO/WSBIM1207/raw/refs/heads/main/docs/figs/2019-06-corr-exam-interro.png")
```
...
| **A domicile** | Je préfère travailler au calme, chez moi, en utilisant les ressources mises à ma disposition. | Je pose mes question sur moodle et fait les interrogations de manière asynchrone.                        | Je m'engage à réserver des séances individuelles au moins toutes les 2 semaines. Et si ça ne va pas, je n'abandonnerai pas et reviendrai suivre le cours en direct. |
