...
- Il y aura des interrogations cotées en début de certaines
  ...
  exercices en cours et à domicile. La figure ci-dessous vous montre
  l'importance de travail régulier qui se traduit par des bons
  résultats durant les interrogations et une bonne cote à l'examen
  final.

```{r scores, fig.cap = "Correlation between the average score at the tests and the final exam (June 2019).", echo = FALSE}
knitr::include_graphics("./2019-06-corr-exam-interro.png")
```


- Le nombre et durée des pauses dépendra du [vote des étudiant(e)s]().
...
| 2 | Jeudi  13/02/2020 | 08h30 - 12h30 | Introduction à R/RStudio et `data.frames`       |
| 3 | Jeudi  20/02/2020 | 08h30 - 12h30 | Analyses de données                             |
| 4 | Jeudi  27/02/2020 | 08h30 - 12h30 | Analyses de données (suite)                     |
| 5 | Jeudi  05/03/2020 | 08h30 - 12h30 | Analyses de données (suite)                     |
| 6 | Jeudi  12/03/2020 | 08h30 - 12h30 | Visualisation de données                        |
| 7 | Jeudi  19/03/2020 | 08h30 - 12h30 | Jointures et recherche reproductible            |
| 8 | Jeudi  26/03/2020 | 08h30 - 12h30 | bioinformatique et éléments de programmation    |
| 9 | Jeudi  02/04/2020 | 08h30 - 12h30 | Exercices supplémentaires et questions/réponses |
|   | Jeudi  14/05/2020 | 08h30 - 12h30 | Examen hors session (à confirmer)               |
