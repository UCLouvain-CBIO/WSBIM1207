...
Assistant(e)s: Jean Fain, (Valentine Robaux), Margot Refuge, Julie
Devis, Axelle Loriot (M1)
...
- Interrogations et examen à resources ouvertes.
...
- Il est **toujours légitime de poser une question**. Il n'y a pas de
  bête question. Si vous vous la posée, d'autres se la posent aussi.
...
# NEW: Travailler le cours de chez soi!

---

- Mode opératoire - réunion individuelle toutes les 2 semaines
- 20 étudiant(e)s
- inscription par email: motivation et confirmer que vous allez
  travailler
- pour quel type d'étudiant?
- même quantité de travail, engagement différent
...
- Il est possible de travailler le cours à l'UCLouvain ou de chez soi!
