...
Assistant(e)s: Jean Fain, Valentine Robaux, Julie Devis, Axelle Loriot (M1)
...
- Vous donnez les moyens d'analyser et de visualiser des données
  (i.e. écrire du code pour générer des résultats).
- Portez un **regard critique** sur des données, vitre approche
...
- Compétences recherchées dans l'industrie, notamment biotech et
  pharmaceutique
- Doctorants suivent ces cours systématiquement depuis l'instauration
  des cours
...
- Présence au cours obligatoire. Pourquoi? Comment?
...
- Travaillez regulièrement, en particulier en participant activement
  au cours (cf interrogations). Inscrivez-vous aux sessions
  individuelles. N'attendez pas la fin du cours pour vous y mettre!
