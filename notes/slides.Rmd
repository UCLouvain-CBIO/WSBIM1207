...
```{r echo=FALSE}
knitr::include_graphics('../figs/alignement-pedagogique.png')
```
...
### _SI_ les étudiant(e)s exécutent les activités d'apprentissage
### _ALORS_ les enseignant(e)s guarantissent qu'ils/elle atteigneront les acquis attendus,
### _ET_ qu'ils/elles seront en mesure de démontrer cette maîtrise lors de l'évaluation et donc de la réussir.
...
Assistant(e)s: Valentine Robaux, Julie Devis, Mathilde Akue, Axelle Loriot (M1)
