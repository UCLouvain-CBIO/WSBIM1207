...
have in a long format using `pivot_longer()` (or `gather()`). Below,
we create two new variables: `test`, that contains `interro1`, ...,
`interro4`, and `score`, that contains the students marks the actual
test.
