...
```{r}
nrow(assay(cptac_se)) == nrow(rowData(cptac_se))
ncol(assay(cptac_se)) == nrow(colData(cptac_se))
```
...
- Explore the object's `colData` and interprete it as the experiment's
  experimental design.
...
- Calculate the log2 fold-change (i.e. the difference of expression
  ...
  highest fold-change. Can you recognise this on the figure?
