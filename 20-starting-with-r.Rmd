...
```{r, fig.cap = "Some notable [CRAN  package](https://cran.r-project.org/) milestones. Data from Henrik Bengtsson available from https://www.jottr.org/2015/08/12/milestone-cran-7000/.", echo = FALSE, message = FALSE}
pkgs <- tibble::tribble(
                    ~Date, ~Packages,
                    "2015-08-12", 7000,
                    "2014-10-29", 6000,
                    ...
                    "2003-04-01", 250)
library("ggplot2")
ggplot(pkgs, aes(Date, Packages)) +
    geom_point() +
    ggtitle("CRAN package milestones (data from Henrik Bengtsson)") +
