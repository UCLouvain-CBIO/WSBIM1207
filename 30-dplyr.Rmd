...
- Does working statue have an influence on beer consumption according
  to gender?
- Do men drink more than women according to age and working statue?
...
<!-- library("ggplot2") -->
<!-- ggplot(data = beers3, -->
<!--        mapping = aes(x = Age, y = mean_consumption, color = Work)) + -->
<!--   geom_line() + -->
<!--   geom_point() + -->
<!--   facet_wrap(~ Gender) + -->
