...
product...).  The variables that don’t change genes or samples will
have the same value in all the rows.  This structure is called a
*long format*, as one column contains all the values, and other
column(s) list(s) the context of the value.
...
representing the data.  This is typically the case with gene
expression values that scientists are used to look as matrices, were
